...
public class AcceptAllSpecification implements Specification<Message> {

    private AcceptAllSpecification() {
    }

    public static AcceptAllSpecification newInstance() {
        return new AcceptAllSpecification();
    }
